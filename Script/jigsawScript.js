...
function jigsaw(canvasID, imageID, rows,columns) {
    ...
    var BLOCK_IMG_WIDTH = 900;
    var BLOCK_IMG_HEIGHT = 675;
    ...
    function OnFinished() {
        ...
        audioElement.setAttribute('src', 'Audio/win_000.mp3');
        audioElement.play();

        remove_width = BLOCK_WIDTH;
        remove_height = BLOCK_HEIGHT;
        // Clear Board
        interval = setInterval(function () { mySelf.ClearGame(); }, 150);
    }
